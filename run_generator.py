...
def style_mixing_example(network_pkl, row_seeds, col_seeds, truncation_psi, col_styles, minibatch_size=4):
    ...
    for row_seed in row_seeds:
        for col_seed in col_seeds:
            ...
            # print('&&&&&&& col_seed', col_seed, col_styles)
            # for ws in w[col_styles]:
            #     str = ''
            #     for e in ws:
            #         str = '{} {}'.format(str, e)
            #     print('&&&', str)
            ...
            # print('### {},{},{},{}'.format(row_seed, col_seed, col_styles, np.newaxis))
            # for ws in w[np.newaxis]:
            #     for ww in ws:
            #         str = ''
            #         for e in ww:
            #             str = '{} {}'.format(str, e)
